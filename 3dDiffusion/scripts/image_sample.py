...
from improved_diffusion.script_util import (
    model_and_diffusion_testdefaults_omni,
...
def main():
    ...
    model, diffusion = create_model_and_diffusion(
        **args_to_dict(args, model_and_diffusion_testdefaults_omni().keys())
    )
...
def create_argparser():
    defaults = dict(
        ...
        num_class=216,
        use_ddim=False,
        model_path="./omni/model.pt", # checkpoint of diffusion
        save_path='./Checkpoint_all/difftf_omni', #save path
    )
    defaults.update(model_and_diffusion_testdefaults_omni())
