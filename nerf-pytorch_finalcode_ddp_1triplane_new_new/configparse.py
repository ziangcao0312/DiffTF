def config_parser():
    ...
    parser.add_argument("--basedir", type=str, default='/nvme/caoziang/3D_generation/Checkpoint_all', 
                        help='where to store ckpts and logs')
    parser.add_argument("--ddp", type=int, default=0, 
                        help='where to store ckpts and logs')
    parser.add_argument("--idx", type=int, default=0, 
                        help='where to store ckpts and logs')
    parser.add_argument("--datadir", type=str, default='/nvme/caoziang/3D_generation/data/apple_001/render', 
                        help='input data directory')
    parser.add_argument("--decoderdir", type=str, default='/nvme/caoziang/3D_generation/data/apple_001/render', 
                        help='input data directory')
    ...
    parser.add_argument("--num_instance", type=int, default=1, 
                        help='input data directory')
    parser.add_argument("--triplanechannel", type=int, default=96, 
                        help='input data directory')
