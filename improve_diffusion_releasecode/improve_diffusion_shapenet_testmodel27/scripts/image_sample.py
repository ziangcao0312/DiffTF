...
def create_argparser():
    defaults = dict(
        ...
        batch_size=5,
        use_ddim=False,
        model_path="/mnt/petrelfs/caoziang/3D_generation/Checkpoint_all/diffusion_shapenet_testmodel27/ema_0.9999_250000.pt",
        gt_path='/mnt/petrelfs/caoziang/3D_generation/Checkpoint_all/shapenet_triplane_new_new/003000.tar',
        save_path='/mnt/petrelfs/caoziang/3D_generation/Checkpoint_all/diffusion_shapenet_testmodel27',
    )
